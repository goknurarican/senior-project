...
export default function Checkout() {
  ...
  const [cart, setCart] = useState<any>(null); // Sepet state'i eklendi
  ...
  const shipping = subtotal > 500 ? 0 : 50; // 500 üzeri kargo bedava
  ...
  const processPayment = async () => {
    // 3. EXPERIMENT SDK / 3DS SİMÜLASYONU
  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto min-h-[calc(100vh-277px)]">
        ...
        {step === 1 && (
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input name="email" type="email" placeholder="Email" className="border p-2 rounded" value={formData.email} onChange={handleInputChange} />
            ...
            <div className="mt-6 text-right">
              <button onClick={() => setStep(2)} className="bg-blue-600 text-white px-6 py-3 rounded hover:bg-blue-700">
                Continue to Payment
              </button>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="mt-6 flex justify-between">
              <button onClick={() => setStep(1)} className="border px-6 py-3 rounded hover:bg-gray-50">
                Back
              </button>
              <button onClick={() => setStep(3)} className="bg-blue-600 text-white px-6 py-3 rounded hover:bg-blue-700">
                Review Order
              </button>
            </div>
          </div>
        ...
        {/* STEP 3: Confirm - DİNAMİK VERİLERLE */}
        {step === 3 && (
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="mt-6 flex justify-between">
              <button onClick={() => setStep(2)} className="border px-6 py-3 rounded hover:bg-gray-50">
                Back
              </button>
              <button onClick={processPayment} className="bg-green-600 text-white px-8 py-3 rounded font-semibold hover:bg-green-700">
                Place Order
              </button>
            </div>
          </div>
